...
import colorWheel from './components/Aside';
...
return {
  ...
  copyActions: () => {
    elements.hslCopyButton.addEventListener('click', () => {
      showTooltip(elements.hslTooltip);
    });
    elements.hexCopyButton.addEventListener('click', () => {
      showTooltip(elements.hexTooltip);
    });
    elements.rgbCopyButton.addEventListener('click', () => {
      showTooltip(elements.rgbTooltip);
    });
  },
